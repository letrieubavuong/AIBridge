...
public interface IGitCommandService
{
    ...
    Task<string?> GetDiffAsync(string repoRoot, string? fromSha, string? toSha, string gitExecutable, int maxBytes = 262144, CancellationToken cancellationToken = default);
    Task<string?> GetWorkingTreeDiffAsync(string repoRoot, string gitExecutable, int maxBytes = 262144, CancellationToken cancellationToken = default);
    ...
    Task<(int Ahead, int Behind)> GetAheadBehindAsync(string repoRoot, string branch, string remoteName, string gitExecutable, CancellationToken cancellationToken = default);
